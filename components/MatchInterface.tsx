                ...
                <div className={`flex-1 h-full flex flex-col relative ${activeTab === 'chat' ? 'hidden lg:flex' : ''}`}>
                    ...
                    {matchState.phase === MatchPhase.DRAFT && (
                        <div className="h-full flex flex-col animate-in fade-in duration-500 overflow-hidden">
                            ...
                            <div className="flex-1 grid grid-cols-[3fr_7fr_3fr] gap-4 overflow-visible p-1">

                                {/* Team A (Left) */}
                                <Card className="h-full flex flex-col border-l-4 border-l-emerald-500/50 rounded-xl overflow-hidden" noPadding>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-full overflow-y-auto">
                                                    {matchState.remainingPool.map(player => (
                                                        <div
                                                            ...
                                                            className={`
                                                        relative group transition-all duration-300 cursor-pointer hover:z-[999]
                                                        ${isMyTurn
                                ...
                                {/* Team B (Right) */}
                                <Card className="h-full flex flex-col border-r-4 border-r-rose-500/50 rounded-xl overflow-hidden" noPadding>
                                        ...
                                        {isCaptain ? (
                                            ...
                                            <div className="flex items-center justify-center gap-3 w-full max-w-md mx-auto">
                                                ...
                                                <button
                                                    ...
                                                    className={`w-10 h-10 rounded-xl border grid place-items-center transition-colors justify-self-end ${matchState.matchCode
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {teamA.map(player => {
                                                ...
                                                return (
                                                    <div
                                                        key={player.id}
                                                        className={`flex items-center justify-between gap-2 p-3 rounded-xl border ${change?.isWinner
